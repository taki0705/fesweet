...
var lienHeElement = document.getElementById('#lienhe');

// Thêm sự kiện click vào ô Liên hệ
lienHeElement.addEventListener('click', function() {
    // Chuyển hướng đến phần liên hệ
    window.location.href = '#lienhe2';
